...
/*`
    ...
    <div id="shop" class="shop">
      <div class="row">
        <div class="item">
          <img src="../vegetables/images/img-1.webp" alt="Vegetables" />
          <div class="details">
            <i class="bi bi-dash-circle"></i>
            <h3>Tomato</h3>
            <i class="bi bi-plus-circle"></i>
        ...
        <div class="item">
          <img src="../vegetables/images/img-2.jpg" alt="Vegetables" />
          <div class="details">
            <i class="bi bi-dash-circle"></i>
            <h3>Carrot</h3>
            <i class="bi bi-plus-circle"></i>
        ...
        <div class="item">
          <img src="../vegetables/images/img-3.jpg" alt="Vegetables" />
          <div class="details">
            <i class="bi bi-dash-circle"></i>
            <h3>Onion</h3>
            <i class="bi bi-plus-circle"></i>
      ...
      <div class="row">
        <div class="item">
          <img src="../vegetables/images/img-4.jpg" alt="Vegetables" />
          <div class="details">
            <i class="bi bi-dash-circle"></i>
            <h3>Cucumber</h3>
            <i class="bi bi-plus-circle"></i>
        ...
        <div class="item">
          <img src="../vegetables/images/img-5.jpg" alt="Vegetables" />
          <div class="details">
            <i class="bi bi-dash-circle"></i>
            <h3>Cabbage</h3>
            <i class="bi bi-plus-circle"></i>
        ...
        <div class="item">
          <img src="../vegetables/images/img-6.jpg" alt="Vegetables" />
          <div class="details">
            <i class="bi bi-dash-circle"></i>
            <h3>Garlic</h3>
            <i class="bi bi-plus-circle"></i>
